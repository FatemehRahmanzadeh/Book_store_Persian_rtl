    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[('1', 'مدیر'), ('2', 'کارمند'), ('3', 'مشتری')], null=True, verbose_name='سمت کاربر')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_addresses', to=settings.AUTH_USER_MODEL, verbose_name='صاحب آدرس')),
            ],
            options={
                'verbose_name': 'آدرس',
